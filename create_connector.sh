...
#       "table.include.list": "public.events, public.org_open_jobs, public.organization",
#       "topic.prefix": "cdc",
...
# connector_group=$(curl -s http://debezium:8083/connectors/postgres-cdc-connector/tasks)
...
# topic_exists=$(kafka-topics --bootstrap-server kafka:9092 --list | grep -w "$topic_name")
